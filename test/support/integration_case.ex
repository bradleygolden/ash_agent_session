defmodule AshAgentSession.IntegrationCase do
  @moduledoc """
  ...
  ## Usage
      ...
      defmodule AshAgentSession.Integration.ReqLLM.OpenAI.MetadataTest do
      ...
      defmodule AshAgentSession.Integration.Ollama.StreamingTest do
        use AshAgentSession.IntegrationCase, provider: :ollama
